...
public class CustomerDAO {
    ...
    public static CustomerDTO getAccount(String email, String password) {
        ...
        try {
            ...
            if (rs.next()) {
                customer = new CustomerDTO(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getDate(5), rs.getString(6), rs.getString(7), rs.getString(9), rs.getInt(10));
